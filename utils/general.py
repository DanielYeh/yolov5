...
def NMS(boxes, overlapThresh = 0.4):
    ...
    y1 = boxes[:, 2]  # y coordinate of the top-left corner
    x2 = boxes[:, 1] + boxes[:, 3]  # x coordinate of the bottom-right corner
    y2 = boxes[:, 2] + boxes[:, 4]  # y coordinate of the bottom-right corner
